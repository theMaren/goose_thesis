...
from models.save_load import load_rgat_model,save_gnn_model_from_dict
from dataset.dataset_rgat import get_tensor_graphs_from_plans
...
def main():
    ...
    model, model_args = load_rgat_model(args.model)
    model.device = device
    ...
    #model_args.save_file = '/home/maren/goose_curriculum/trained_models/blocksworld_gnn_ilg_test_retrained.model'
