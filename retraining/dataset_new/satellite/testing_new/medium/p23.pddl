;; satellites=34, instruments=63, modes=5, directions=26, out_folder=testing_new/medium, instance_id=23, seed=2030
...
(define (problem satellite-23)
 ...
 (:init 
    ...
    (calibration_target ins33 dir12)
    ...
    (calibration_target ins59 dir23)
    (calibration_target ins60 dir13)
    ...
    (on_board ins33 sat24)
    (on_board ins34 sat30)
