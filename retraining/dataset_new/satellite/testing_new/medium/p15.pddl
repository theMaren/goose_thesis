;; satellites=27, instruments=45, modes=4, directions=22, out_folder=testing_new/medium, instance_id=15, seed=2022
...
(define (problem satellite-15)
 ...
 (:init 
    ...
    (calibration_target ins13 dir22)
    ...
    (on_board ins11 sat26)
    (on_board ins12 sat17)
    (on_board ins13 sat3)
    (on_board ins14 sat8)
    (on_board ins15 sat2)
    (on_board ins16 sat23)
    (on_board ins17 sat7)
    (on_board ins18 sat4)
    (on_board ins19 sat6)
