;; satellites=31, instruments=56, modes=4, directions=25, out_folder=testing_new/medium, instance_id=20, seed=2027
...
(define (problem satellite-20)
 ...
 (:init 
    ...
    (calibration_target ins21 dir16)
    ...
    (calibration_target ins41 dir25)
