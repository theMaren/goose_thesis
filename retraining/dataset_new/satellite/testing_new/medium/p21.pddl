;; satellites=32, instruments=59, modes=5, directions=25, out_folder=testing_new/medium, instance_id=21, seed=2028
...
(define (problem satellite-21)
 ...
 (:init 
    ...
    (calibration_target ins53 dir24)
    (calibration_target ins54 dir9)
    (calibration_target ins55 dir21)
    (calibration_target ins56 dir13)
    (calibration_target ins57 dir15)
    ...
    (on_board ins28 sat28)
    (on_board ins29 sat18)
    (on_board ins30 sat5)
    (on_board ins31 sat25)
