;; satellites=37, instruments=72, modes=5, directions=28, out_folder=testing_new/medium, instance_id=27, seed=2034
...
(define (problem satellite-27)
 ...
 (:init 
    ...
    (calibration_target ins10 dir25)
    ...
    (calibration_target ins25 dir20)
    ...
    (calibration_target ins50 dir7)
    (calibration_target ins51 dir22)
    (calibration_target ins52 dir11)
    (calibration_target ins53 dir16)
    (calibration_target ins54 dir13)
    (calibration_target ins55 dir21)
    (calibration_target ins56 dir22)
    ...
    (calibration_target ins64 dir18)
    (calibration_target ins65 dir18)
    (calibration_target ins66 dir14)
    (calibration_target ins67 dir3)
    (calibration_target ins68 dir22)
    (calibration_target ins69 dir10)
    (calibration_target ins70 dir19)
    (calibration_target ins71 dir11)
    (calibration_target ins72 dir22)
    (on_board ins1 sat6)
    (on_board ins2 sat28)
    (on_board ins3 sat35)
    (on_board ins4 sat29)
