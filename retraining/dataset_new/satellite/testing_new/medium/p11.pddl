;; satellites=23, instruments=37, modes=4, directions=20, out_folder=testing_new/medium, instance_id=11, seed=2018
...
(define (problem satellite-11)
 ...
 (:init 
    ...
    (calibration_target ins31 dir17)
    ...
    (on_board ins19 sat11)
    (on_board ins20 sat8)
    (on_board ins21 sat2)
    (on_board ins22 sat23)
    (on_board ins23 sat21)
    (on_board ins24 sat3)
